...
const Portfolio = () => {
    ...
    const portfolios = [
        ...
        },
        {
            id: 3,
            src: lagunusatara,
            appname: "Indonesian national anthem songs search app with speech recognition",
            link: "https://github.com/try333",
            stack: ["React Native", "JavaScript", "Realm"],
        },
        {
    ...
    return (
        <div name="portfolio" className="bg-gradient-to-b from-black to-gray-800 w-full text-white md:pb-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-8">
                        <div className="w-full">
                            <div className="slide-container w-full">
                                ...
                                <Slide slidesToShow={portfol} indicators={indicators} transitionDuration={200} canSwipe={true}>
                                    {portfolios.map(porto => (
                                        <div className="each-slide w-full md:px-3" key={porto.id}>
                                            <div className="shadow-md shadow-gray-600 rounded-lg">

                                                <img src={porto.src} alt="" className="rounded-md duration-200 hover:scale-105 w-full" />
                                                <div className="flex items-center justify-center text-center bottom-0">
                                                    {/* <a href={link} target="_blank" className='text-center'> */}
                                                    <span className="px-6 py-3 duration-200 hover:scale-105">{porto.appname}</span>
                                                ...
                                                <div className='flex justify-center pb-4'>
                                                    {porto.stack.map(stack => <p><span class="bg-blue-100 text-blue-800 text-sm font-medium px-2.5 py-0.5 mx-1 rounded dark:bg-blue-900 dark:text-blue-300">{stack}</span></p>)}
                                                </div>
