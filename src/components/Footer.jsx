...
<footer class="p-4 bg-gradient-to-b from-black to-gray-800">
    
    <div class="flex mx-auto justify-center text-center">
       
        <div class="flex mt-4 space-x-6">
            <a href="https://facebook.com/adhy.zzz" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" rel="noreferrer">
            ...
            <a href="https://instagram.com/try33e" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" rel="noreferrer">
            ...
            <a href="https://www.linkedin.com/in/tri-hariadi-881827160/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" rel="noreferrer">
            <FaLinkedin size={40} alt="Linkedin Icon" />
                
                <span class="sr-only">Linkedin page</span>
            </a>
            <a href="https://github.com/try333" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" rel="noreferrer">
